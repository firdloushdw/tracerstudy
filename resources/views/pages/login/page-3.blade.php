...
<script type="text/javascript">
	document.getElementsByClassName('asked-login')[2].classList.add('pertanyaan-login-active')
</script>
<div class="border border-secondary rounded text-center d-flex align-items-center overflow-hidden">
	<div class="py-2 bg-success-1 me-2" style="width: 40%; top: 0; height: 30px"></div>
	40%
</div>
<br>
<div class="border border-secondary rounded position-relative overflow-hidden p-md-3 p-2">
	<h5 class="text-primary-1 my-0"><strong>Wirausaha Alumni</strong></h5>
	...
	<div class="mt-3 form-group text-end">
		<button name="page-3" class="btn bg-warning-1"><strong>Selanjutnya</strong></button>
	</div>
</div>
@endsection
...
<div class="mx-md-5 mx-3">
	<a href="{{ route('admin.kuesioner') }}" class="text-decoration-none text-dark"> Kelola Kuesioner</a> <i class="fas fa-chevron-right mx-3"></i> <span class="text-primary-1"><strong>{{ $_GET['nama'] }}</strong></span>
	<br><br>
	...
	<div>
		<div class="bg-white borderradius-10 border border-1 border-secondary p-4" style="text-align: justify;">
			<div class="d-md-flex align-items-center">
				<div class="col-md-9">
					<h5 class="my-0"><strong>{{ $_GET['nama'] }}</strong></h5>
				</div>
			...
			<div>
				...
				<div class="row">
					<div class="col-md-10">
						<input type="" name="" class="form-control bg-white" value="{{ $data['a'] }}" readonly="" placeholder="Jawaban Disini">
					</div>
					...
					<div class="col-md-2 mt-md-0 mt-2">
						...
						@php $kue = 1 @endphp
						@endif
						<a href="javascript:;" onclick="updatekuesioner({{ $kue }})" class="edit text-dark border border-secondary borderradius-10 p-2 mx-2"><i class="fas fa-edit text-dark"></i></a>
						<a href="{{ route('admin.kuesioner') }}/delete/pertanyaan/{{$kue}}" class="delete text-dark border border-secondary borderradius-10 p-2 mx-2"><i class="fas fa-trash text-dark"></i></a>
					</div>
				</div>
				@endif
			</div>

...
<div class="container my-5">
	<a href="{{ route('home') }}" class="text-decoration-none text-dark"> Beranda</a> <i class="fas fa-chevron-right mx-3"></i> <a href="{{ route('karir') }}" class="text-decoration-none text-dark"> Informasi Karir</a> <i class="fas fa-chevron-right mx-3"></i> <span class="text-primary-1"><strong>Tokopedia</strong></span>
	<div class="karir mt-4">
		<div class="row">
			<div class="col-md-8">
				<h5 class="mb-2"><strong>TOKOPEDIA</strong></h5>
				...
				<img src="{{ asset('assets/images/lowongan/karir-2.png') }}" width="100%" class="mt-2">
				<p class="mt-4" style="text-align: justify;">
					PT Tokopedia merupakan perusahaan perdagangan elektronik atau sering disebut toko daring. Saat ini Tokopedia kembali membuka peluang kepada fresh graduate untuk berkarir bersama si Hijau:
					<ul>
						<li>Store Manager</li>
						<li>Graphic Designer</li>
						<li>Mobile Developer</li>
					</ul>
					Fresh graduate are welcome to apply. Silahkan kirim CV dan Portfolio (jika diperlukan) terbaik kamu di link berikut <a href="https://Lifeatokopedia.com">https://Lifeatokopedia.com</a> Pendaftaran lamaran ini terbuka mulai tanggal 12 April 2023 - 12 Mei 2023. Salam semangat!
				</p>
			</div>

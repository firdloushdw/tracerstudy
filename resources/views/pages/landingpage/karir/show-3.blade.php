...
<div class="container my-5">
	<a href="{{ route('home') }}" class="text-decoration-none text-dark"> Beranda</a> <i class="fas fa-chevron-right mx-3"></i> <a href="{{ route('karir') }}" class="text-decoration-none text-dark"> Informasi Karir</a> <i class="fas fa-chevron-right mx-3"></i> <span class="text-primary-1"><strong>TIKET.COM</strong></span>
	<div class="karir mt-4">
		<div class="row">
			<div class="col-md-8">
				<h5 class="mb-2"><strong>Tiket.com</strong></h5>
				...
				<img src="{{ asset('assets/images/lowongan/karir-3.png') }}" width="100%" class="mt-2">
				<p class="mt-4" style="text-align: justify;">
					tiket.com adalah pionir online travel agent (OTA) di Indonesia yang berdiri sejak tahun 2011. Pada tahun 2017, tiket.com berafiliasi dengan Blibli dan pada tahun 2021 menjadi anak perusahaan terkonsolidasi dari Blibli.
					<ul>
						<li>Store Manager</li>
						<li>Graphic Designer</li>
						<li>Mobile Developer</li>
					</ul>
					Fresh graduate are welcome to apply. Silahkan kirim CV dan Portfolio (jika diperlukan) terbaik kamu di link berikut <a href="https://Lifeatiket.com">https://Lifeatiket.com</a> Pendaftaran lamaran ini terbuka mulai tanggal 12 April 2023 - 12 Mei 2023. Salam semangat!
				</p>
			</div>

...
<div class="container my-5">
	<a href="{{ route('home') }}" class="text-decoration-none text-dark"> Beranda</a> <i class="fas fa-chevron-right mx-3"></i> <a href="{{ route('karir') }}" class="text-decoration-none text-dark"> Informasi Karir</a> <i class="fas fa-chevron-right mx-3"></i> <span class="text-primary-1"><strong>PT. Muda Berkarya</strong></span>
	<div class="karir mt-4">
		<div class="row">
			<div class="col-md-8">
				<h5 class="mb-2"><strong>PT. Muda Berkarya</strong></h5>
				...
				<img src="{{ asset('assets/images/lowongan/karir-1.png') }}" width="100%" class="mt-2">
				<p class="mt-4" style="text-align: justify;">
					PT. Muda Berkarya kembali hadir dengan membuka lowongan pekerjaan lebih banyak dari yang sebelumnya. Saat ini terdapat 3 Lowongan yang dapat kalian lamar untuk berkarir dengan PT. Muda Berkarya yang diantaranya:
					<ul>
						<li>Store Manager</li>
						<li>Graphic Designer</li>
						<li>Mobile Developer</li>
					</ul>
					Fresh graduate are welcome to apply. Silahkan kirim CV dan Portfolio (jika diperlukan) terbaik kamu di link berikut <a href="https://mudaberkarya.com">https://mudaberkarya.com</a> Pendaftaran lamaran ini terbuka mulai tanggal 12 April 2023 - 12 Mei 2023. Salam semangat!
				</p>
			</div>

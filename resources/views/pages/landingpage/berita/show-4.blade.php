...
<div class="container my-5">
	<a href="{{ route('home') }}" class="text-decoration-none text-dark"> Beranda</a> <i class="fas fa-chevron-right mx-3"></i> <a href="{{ route('berita') }}" class="text-decoration-none text-dark"> Berita</a> <i class="fas fa-chevron-right mx-3"></i> <span class="text-primary-1"><strong>Workshop Finance Bersama BNI</strong></span>
	<div class="berita mt-4">
		<div class="row">
			<div class="col-md-8">
				<h5 class="mb-2"><strong>Workshop Finance Bersama BNI</strong></h5>

				<small class="me-1"><i class="fas fa-clock me-2"></i>Maret, 18 2023</small>
				...
				<p class="mt-4" style="text-align: justify;">
					BNI Goes To UNI kembali hadir dengan rangkaian Workshop Finance. Workshop ini bertujuan untuk memberikan pelatihan finance kepada mahasiswa tingkat akhir/calon Alumni  untuk membantu bekal bagi mahasiswa/calon alumni yang akan terjun ke dunia kerja.
					<br><br>
					Kamu dapat mengikuti workshop ini dengan daftar melaluui Link <a href="https://bit.ly/FinanceworkshopwiyhBNILife">https://bit.ly/FinanceworkshopwiyhBNILife</a>
				</p>
			</div>

...
<div class="container my-5">
	<a href="{{ route('home') }}" class="text-decoration-none text-dark"> Beranda</a> <i class="fas fa-chevron-right mx-3"></i> <a href="{{ route('berita') }}" class="text-decoration-none text-dark"> Berita</a> <i class="fas fa-chevron-right mx-3"></i> <span class="text-primary-1"><strong>Pengisian Tracer Study Alumni 2023</strong></span>
	<div class="berita mt-4">
		<div class="row">
			<div class="col-md-8">
				<h5 class="mb-2"><strong>Pengisian Tracer Study Alumni 2023</strong></h5>

				<small class="me-1"><i class="fas fa-clock me-2"></i>Februari, 08 2023</small>
				<small class="ms-2"><i class="fas fa-user-circle me-2"></i>Oleh: Admin</small><br>

				<img src="{{ asset('assets/images/berita/berita-2.png') }}" width="100%" class="mt-2">
				<p class="mt-4" style="text-align: justify;">
					Salam hangat kepada seluruh Alumni Tahun 2023. Kami, Universitas mengimbau para Alumni untuk dapat mengisi kuesioner Tracer Study yang telah disediakan di dalam website ini (klik disini). Feedback dan Informasi yang Alumni berikan akan sangat memberikan manfaat bagi perkembangan universitas dan Mahasiswa lain tentunya. 
				</p>
			</div>

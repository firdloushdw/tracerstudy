...
<div class="container my-5">
	<a href="{{ route('home') }}" class="text-decoration-none text-dark"> Beranda</a> <i class="fas fa-chevron-right mx-3"></i> <a href="{{ route('berita') }}" class="text-decoration-none text-dark"> Berita</a> <i class="fas fa-chevron-right mx-3"></i> <span class="text-primary-1"><strong>Test Toefl/Ptesol Bersama</strong></span>
	<div class="berita mt-4">
		<div class="row">
			<div class="col-md-8">
				<h5 class="mb-2"><strong>Test Toefl/Ptesol Bersama</strong></h5>

				<small class="me-1"><i class="fas fa-clock me-2"></i>Mei, 08 2023</small>
				<small class="ms-2"><i class="fas fa-user-circle me-2"></i>Oleh: Admin</small><br>

				<img src="{{ asset('assets/images/berita/berita-5.png') }}" width="100%" class="mt-2">
				<p class="mt-4" style="text-align: justify;">
					Universitas A kembali membuka pendaftaran untuk TOEFL dan PTESOL sebagai salah satu syarat sidang/lulus bagi  tingkat semester akhir. Selain itu Test ini juga dapat diikuti oleh Alumni ataupun warga luar kampus. Silahkan <a href="#">klik disini</a> untuk mendaftarkan diri anda untuk mengikuti Test TOEFL/PTESOL
				</p>
			</div>
